...
import ClientBlockAndUnblock from './ClientBlockAndUnblock'
...
function ClientList() {
  ...
  return (
    ...
    <div className='bg-stone-900 h-full px-20 py-20'>
      ...
      {BUModal ? <ClientBlockAndUnblock setBUModal={setBUModal} Username={Username} Status={Status} Id={Id} setRefresh={setRefresh} Refresh={Refresh} /> : ''}

      <p className='text-center font-serif font-semibold text-xl text-white'>Clients</p>
      {allData?.length !== 0 ?
        <div className='mb-3'>
