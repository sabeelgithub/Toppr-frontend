...
import { AddTutorial, getDomains } from "../../../Axios/Services/AdminServices";
...
function AddTutorialModal({setAddModal,Refresh,setRefresh}) {
    ...
    const {values, errors, touched, handleBlur, handleChange, handleSubmit} = useFormik({
        ...
        validationSchema:AddTutorialSchema,
        onSubmit,
    })
                        ...
                        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                            ...
                            >
                                ...
                                <button onClick={()=>{
                                    ...
                                    <p className='font-extrabold text-2xl'>Add New Tutorial</p>
