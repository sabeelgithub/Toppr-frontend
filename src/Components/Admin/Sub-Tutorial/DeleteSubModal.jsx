...
import { DeleteSubTutorial } from "../../../Axios/Services/AdminServices";



function DeleteSubModal({setDeleteModal,Refresh,setRefresh,FindItem}) {
    ...
    const Delete = async()=>{
        ...
        const response = await DeleteSubTutorial(data)
                                    ...
                                    <div class="relative w-full max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete {FindItem.sub_tutorial_name} ? </h3>
                                                <button  onClick={()=>{
                                                    Delete()
                                                    setDeleteModal(false)
