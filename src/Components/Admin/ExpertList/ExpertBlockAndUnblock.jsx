...
import {HandleBlockAndUnblock, handleClientStatus, handleExpertStatus} from "../../../Axios/Services/AdminServices";
import { toast } from 'react-toastify';
import { useSelector } from "react-redux";


function ExpertBlockAndUnblock({setBUModal,Username,Status,Id,setRefresh,Refresh}) {
                                    ...
                                    <div class="relative w-full max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                { Status ?  <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure want to Unblock {Username}?</h3> : <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure want to Block {Username}?</h3> }
...
export default ExpertBlockAndUnblock
